...
REFERENCE_MAPPINGS = {
    ...
    "food_values": {
        "reference_name": "food_values",
        "primary_key_variations": ["Food Value Code", "food_value_code"],
        "description_variations": ["Food Value", "food_value"],
        "output_columns": {"pk": "Food Value Code", "desc": "Food Value"},
        "additional_columns": {},
    ...
    "industries": {
        "reference_name": "industries",
        "primary_key_variations": ["Industry Code", "industry_code"],
        "description_variations": ["Industry", "industry"],
        "output_columns": {"pk": "Industry Code", "desc": "Industry"},
        "additional_columns": {},
    ...
    "factors": {
        "reference_name": "factors",
        "primary_key_variations": ["Factor Code", "factor_code"],
        "description_variations": ["Factor", "factor"],
        "output_columns": {"pk": "Factor Code", "desc": "Factor"},
        "additional_columns": {},
