...
import pandas as pd
from . import logger
from .utils.dataclass import ForeignKeyRelationship, FAODataset
...
class FAOForeignKeyMapper:
    ...
    def enhance_datasets_with_foreign_keys(self) -> Dict[str, FAODataset]:
    ...
    def _process_dataset_foreign_keys(self, dataset: FAODataset):
