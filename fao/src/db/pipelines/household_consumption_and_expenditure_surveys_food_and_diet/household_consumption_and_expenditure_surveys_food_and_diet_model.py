...
class HouseholdConsumptionAndExpenditureSurveysFoodAndDiet(Base):
    __tablename__ = "household_consumption_and_expenditure_surveys_food_and_diet"
    ...
    #     #         #         #             #         #             #         #             #         #             #         #             #         #             #         #         #         #         #         #             #             
    #         # __table_args__ = (
    #     Index("ix_4085fcd2_uniq_uniq", 
    #         'survey_code_id', 'geographic_level_code_id', 'food_group_code_id', 'indicator_code_id', 'element_code_id', 'flag_id', 'unit',
    #         unique=True),
    # )
    #         
    def __repr__(self):
        # Show first few columns for datasets
        return f"<HouseholdConsumptionAndExpenditureSurveysFoodAndDiet(id={self.id})>"
